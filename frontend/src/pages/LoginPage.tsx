...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        toast.success('Welcome to ProTrack!');
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 lg:px-20">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-primary-foreground mb-6 leading-tight">
            Track Your Final Year Projects with Ease
          </h1>
          
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-md">
            A comprehensive platform for managing FYP progress, student groups, and evaluations. 
